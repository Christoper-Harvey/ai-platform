...
# ResNet44  | 7(NA)| 92.50     |
# ResNet56  | 9 (6)| 93.01     |
# ResNet110 |18(12)| 93.63     |
# ResNet164 |27(18)| 94.54     |
# ResNet1001| (111)| 95.08+-.14|
# ------------------------------------------------------------------
n = 3
depth = n * 9 + 2

# Model name, depth
model_type = 'ResNetv%d' % (depth)
...
def resnet(input_shape, depth, num_classes=10):
    ...
    # resnet performs Conv2D with BN-ReLU on input before splitting into 2 paths
